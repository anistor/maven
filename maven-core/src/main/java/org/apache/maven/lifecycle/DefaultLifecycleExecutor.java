    ...
    implements LifecycleExecutor
{
    ...
    */
        ...
        throws LifecycleExecutionException, PluginNotFoundException
    {
        ...
        PluginDescriptor pluginDescriptor = verifyPlugin( plugin, project, session );
    ...
    public TaskValidationResult isTaskValid( String goal, MavenSession session, MavenProject project )
    {
